...
public class View {
    public final String MENU_CHOOSE_MSG = "Choose an option: ";
    ...
    public final String WEIGHTS_AUTOTEST_ENTER_MSG = "Enter max weight for the test(W > 100): ";
    public final String MAX_CAPACITY_ENTER_MSG = "Enter max weight you can take: ";
    public final String THREAD_NUMBER_ENTER_MSG = "Enter amount of threads to procces the algorithm(0 < TN < 50): ";
    ...
    public final String STEP_EXECUTING_MSG = "Calculating a test batch with the size ";
    ...
    public final String TESTS_OK_MSG = "All tests are correct!\n";
    ...
    public void printTestSolutions(ArrayList<ArrayList<KnapsackSolution>> testSolutions) {
